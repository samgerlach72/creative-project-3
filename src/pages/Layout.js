...
const Layout = () => {
  return (
    ...
    <div class = 'line'></div>
    <p class = 'disclosure'>I do not claim these photo's as my material. This website was created for my web design class. All Photos are under creative commons license. Photo# 1 by Cristi Sebastian Photography. Photo #2 by Joshua Humphrey. </p>
    </>
  )
};
